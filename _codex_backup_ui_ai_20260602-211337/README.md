...
|---|---|
| `isnet-general-use` | Uso general, modelo por defecto |
| `u2net` | General equilibrado |
| `u2net_human_seg` | Personas y retratos |
| `birefnet-general` | Alta precision general |
...
3. Elegir modelo IA si se remueve fondo.
4. Activar o desactivar mejora de calidad.
5. Ajustar factor, nitidez y contraste.
6. Procesar y revisar preview antes/despues.
7. Guardar como PNG con transparencia o JPG con fondo blanco.
