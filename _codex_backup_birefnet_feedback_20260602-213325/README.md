...
| `birefnet-general` | Maxima precision general |
...
3. Elegir modelo IA si se remueve fondo. Deja `u2net` como primera opcion porque es el mejor resultado confirmado hasta ahora.
...
- Si `u2net` no resuelve una imagen concreta, prueba `birefnet-general-lite` o `bria-rmbg` como alternativa puntual.
