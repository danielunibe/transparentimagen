...
5. [ ] Evaluar `quality_pyiqa` como scoring opcional sin dependencia obligatoria.
...
- Calidad simple ya esta visible; score real queda condicionado a evidencia y peso del runtime.
