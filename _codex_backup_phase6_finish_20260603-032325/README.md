...
- Fase 6 base: metricas simples en resultado/UI/export completadas.
...
2. Fase 6.2: evaluar `quality_pyiqa` sin volverlo dependencia obligatoria.
3. Profundizar Fase 10 con workflows reales de img2img/IP-Adapter/ControlNet en ComfyUI.
4. Profundizar Fase 7/8 solo con modelos externos/ONNX ya probados.
