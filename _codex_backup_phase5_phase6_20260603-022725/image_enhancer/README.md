...
14. Pulsa `Preview 25%` para una prueba rapida sin upscale completo.
15. Pulsa `Generate` para render final con maxima calidad disponible.
16. Usar `Refinar bordes` si necesitas perfeccionar el contorno.
17. Guardar como PNG con transparencia o JPG con fondo blanco.
...
|---|---|---|
| `segmentation_birefnet` | `Listo` | Activa `birefnet-general` como segmentacion premium |
...
1. Fase 3: estabilizar CUDA real o aceptar/documentar fallback CPU final.
2. Fase 4: segmentacion premium con BiRefNet.
3. Fase 5: UE5 Texture Tools v1 con export profile, albedo, depth y normal map progresivo.
