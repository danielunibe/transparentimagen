...
1. Validar end-to-end un ComfyUI real con alguno de los workflows externos ya preparados.
2. Profundizar Fase 5: elegir modelos ONNX viables para `ue5_depth`/`ue5_normal_map`.
