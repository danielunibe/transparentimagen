...
- [ ] Validar backend real de `quality_pyiqa` en esta maquina o via runtime externo dedicado.
...
- [~] Validar ComfyUI local como backend externo opcional: integracion lista; validacion end-to-end pendiente de un servidor ComfyUI real activo.
...
1. [ ] Levantar ComfyUI real y validar un workflow concreto usando las plantillas externas ya preparadas.
