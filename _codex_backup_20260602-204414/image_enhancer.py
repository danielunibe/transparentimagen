...
class ImageEnhancerApp:
    ...
    def _build_left_panel(self, parent):
        ...
        self.model_var = tk.StringVar(value=MODEL_KEYS[0])
    ...
    def _on_model_change(self, event):
        ...
        self.model_var.set(MODEL_KEYS[idx])
            ...
            if self.do_rembg.get():
                if not REMBG_AVAILABLE:
                    self.root.after(0, lambda: messagebox.showerror(
                        "rembg no instalado",
                        "Instala rembg con:\n\n  pip install rembg\n\n"
                        "La primera ejecución descarga el modelo (~170 MB)."))
