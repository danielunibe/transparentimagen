...
class ImageEnhancerApp:
    ...
    def _build_preview_panel(self, parent):
        ...
        self.refine_btn = tk.Button(
            save_frame, text="Refinar bordes",
            command=self._open_edge_refiner,
            bg=PANEL, fg=TEXT_DIM,
            font=("Consolas", 9, "bold"), relief="flat",
            cursor="hand2", padx=10, pady=7,
            state="disabled")
        self.refine_btn.pack(fill="x", pady=(6, 0))
    ...
    def _load_image(self):
        ...
        try:
            ...
            self.refine_btn.configure(state="disabled", bg=PANEL, fg=TEXT_DIM)
    ...
    def _on_done(self):
        ...
        self.refine_btn.configure(state="normal", bg=PANEL2, fg=TEXT)
