...
- Cambios permitidos: detector facial local OpenCV, crop/mezcla para CodeFormer o GFPGAN externos, fallback no bloqueante, modulo `color_local_restore`, smokes `--smoke-portrait` y `--smoke-color-restore`.
